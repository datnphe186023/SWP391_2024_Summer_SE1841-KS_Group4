 ...
 * @author Admin
 */
public class ViewDetailsHealthCheckUpServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HealthCheckUp healthCheckUp = healthCheckUpDAO.getHealthCheckUpsById(healthId);
        request.setAttribute("healthCheckUp", healthCheckUp);
        request.getRequestDispatcher("detailsHealthCheckUp.jsp").forward(request, response);
    }
