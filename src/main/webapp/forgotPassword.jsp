    ...
    <body>
        <div class="uf-form-signin">
            <div class="text-center" >
                ...
                <h4 style="color: #e2dcdc">Quên mật khẩu?</h4>
            </div>
            <form class="mt-4" action="forgotPassword" method="POST">
                <div class="input-group uf-input-group input-group-lg mb-3">
                    <span class="input-group-text fa fa-user"></span>
                    <input type="text" class="form-control" name="email" placeholder="Nhập tài khoản hoặc email" required>
                </div>
                <span  style="color:red; display: block; margin: 10px">${error}</span>
                <div class="d-grid mb-4">
                    <button type="submit" class="btn uf-btn-primary btn-lg">Xác nhận</button>
                </div>
