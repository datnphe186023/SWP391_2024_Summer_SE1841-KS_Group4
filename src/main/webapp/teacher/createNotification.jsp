            ...
            <div id="wrapper">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <form action="createnotifi" method="post" onsubmit="return validateForm()">
                                    <div class="card-body">
                ...
                <script>
                                                function validateForm() {
                                                    const heading = document.getElementsByName('heading')[0];
                                                    const content = document.getElementsByName('content')[0];

                                                    // Trim leading whitespace
                                                    heading.value = heading.value.trimStart();
                                                    content.value = content.value.trimStart();
