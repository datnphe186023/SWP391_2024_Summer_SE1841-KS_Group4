            ...
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <form action="sendapplication" method="post">
                            ...
                            <div class="mb-3" id="datePickerContainer" style="display:none;">
                                <h4 class="h4 mb-2 text-gray-800">Chọn Ngày</h4>
                                <input type="date" class="form-control mb-3" name="date">
                            </div>

                            <div class="mb-3">
                                <h4 class="h4 mb-2 text-gray-800">Lý do</h4>
                                <textarea class="form-control mb-5" type="text" placeholder="Lý do" name="details" rows="5" required></textarea>
                            </div>
                ...
                <script>
                    document.getElementById('applicationType').addEventListener('change', function() {
                        ...
                        if (selectedType === 'AT000001' || selectedType === 'AT000003') {
