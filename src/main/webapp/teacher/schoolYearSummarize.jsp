                                            ...
                                            <c:forEach items="${requestScope.pupils}" var="pupil" varStatus="status">
                                                <tr>
                                                    ...
                                                    <c:if test="${pupil.isSummarized(requestScope.schoolYearId) eq true}">
                                                        ...
                                                        <td>
                                                            <select class="form-control" name="evaluate${pupil.id}">
                                                        ...
                                                        <td>
                                                            <textarea name="note${pupil.id}" class="form-control" rows="1">${evaluation.teacherNote}</textarea>
                                                        </td>
                                                    </c:if>
                                                    ...
                                                    <c:if test="${pupil.isSummarized(requestScope.schoolYearId) eq false}">
                                                        ...
                                                        <td>
                                                            <textarea name="note${pupil.id}" class="form-control" rows="1"></textarea>
                                                        </td>
                                                    </c:if>
                    ...
                    <c:otherwise>
                        <div class="card shadow mb-4">
                            <div class="card-body" style="display: flex; justify-content: center">
                                <p style="color: red">  Dữ liệu tổng kết sẽ được cập nhập vào tuần cuối cùng của năm học !</p>
                            </div>
                        </div>
                    </c:otherwise>
                </c:choose>
