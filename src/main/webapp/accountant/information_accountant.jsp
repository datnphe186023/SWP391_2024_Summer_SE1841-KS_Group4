...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-edit"></i> Thông tin kế toán</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="tile">
                        <div class="tile-body">
                            <form method="post" action="/accountant/information" enctype="multipart/form-data">
        ...
        <script>
                            ...
                            function redirectToInfoPage() {
                                window.location.href = '${pageContext.request.contextPath}/accountant/information';
                            }
        </script>
    </body>
</html>
